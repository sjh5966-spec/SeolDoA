...
Extended PIT collection supports fiscal years 2015..2025 for long-horizon robustness testing; the original 2023..2025 OOS interpretation remains separately frozen.
...
src = src.replace(
    ...
    "if year<2015 or year>2025: raise SystemExit('V2 extended PIT wrapper supports fiscal years 2015..2025 only')"
)
src = src.replace(
