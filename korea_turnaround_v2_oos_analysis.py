...
EVENT_COLS=['corp_code','stock_code','market','business_year','fiscal_quarter','signal_date','signal_year','entry_date','exit_date','mcap','op_q','prior_op_q','op_yoy_pct','R20','benchmark_R20','market_excess_R20','matched_peer_n','matched_peer_median_R20','matched_excess_R20']
...
def main():
    ...
    out=pd.DataFrame(rows,columns=EVENT_COLS); out.to_csv(OUT,index=False)
